          ...
          projects={[
            {
              title: 'JW Control',
              description:
                'Designed and deployed a user interface for JW Control using the Astro framework. The application was hosted on Vercel and linked to a Cloudflare-managed domain.',
              links: [{ url: 'https://jw-control.com', label: 'Live Site' }],
            },
            {
          ...
          projects={[
            {
              ...
              description:
                'Designed user-centered interfaces, applying usability and accessibility principles to ensure an intuitive and seamless experience. Used Figma to prototype and create designs, ensuring responsive and cross-platform compatibility.',
              links: [
                {
          ...
          projects={[
            {
              ...
              links: [
                ...
                {
                  url: 'https://github.com/Abraham-ch/Breath-project/blob/main/InformeFinal_Digitales_Calle_Chafloque.pdf',
