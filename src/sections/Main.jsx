    ...
    >
      <div>
        ...
        <p className='px-5 py-3 text-sm sm:text-base text-slate-700 max-w-2xl dark:text-gray-200'>
          Full-Stack Developer, specialized in Frontend with a solid foundation
          in electronics and programming, focused on software development and
          the use of technological tools. Experienced in creating innovative
          solutions and coordinating initiatives that integrate technology and
          strategy for the growth of new projects.
        </p>
